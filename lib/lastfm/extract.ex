defmodule Lastfm.Extract do
  ...
  """
  @impl true
  def scrobbles(user, {page, limit, from, to}, api \\ %Lastfm.Client{method: "user.getrecenttracks"}) do
  ...
  """
  @impl true
  def playcount(user, {from, to}, api \\ %Lastfm.Client{method: "user.getrecenttracks"}) do
